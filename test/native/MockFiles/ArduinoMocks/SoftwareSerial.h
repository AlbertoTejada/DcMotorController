...
class SoftwareSerialMock : public SoftwareSerial {
  ...
  public:
    ...
    MOCK_METHOD(size_t, write, (const char *str));
    ...
    MOCK_METHOD(bool, isListening, ());
    MOCK_METHOD(bool, stopListening, ());
    MOCK_METHOD(bool, overflow, ());
    MOCK_METHOD(void, restore_listener, ());
    MOCK_METHOD(uint8_t, at, (const uint8_t index));
