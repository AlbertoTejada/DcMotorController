...
class SparkMock {
  public:
    MOCK_METHOD(void, variable, (const char*, int*));
    MOCK_METHOD(void, function, (const char*, const char*));
    MOCK_METHOD(void, publish, (const char *, const char *));
    MOCK_METHOD(void, subscribe, (const char*, const char*));
    MOCK_METHOD(void, connect, ());
    MOCK_METHOD(void, disconnect, ());
    MOCK_METHOD(bool, connected, ());
    MOCK_METHOD(void, process, ());
    MOCK_METHOD(char *, deviceID, ());
    MOCK_METHOD(void, sleep, ());
    MOCK_METHOD(void, sleep, (int));
    MOCK_METHOD(void, sleep, (const char*, int));
    MOCK_METHOD(void, sleep, (uint16_t, uint16_t, int));
    MOCK_METHOD(void, syncTime, ());
};
