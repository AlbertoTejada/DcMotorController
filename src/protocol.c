...
void protocol_init() 
{
  ...
  //iscomment = false;
  //TODO: report_init_message(); // Welcome message   


  /*PIN INTERRUPTIONS FOR RESET, HOLD AND CYCLE START*/
...
/*INTERRUPTION HANDLER FOR RESET, FEED HOLD AND CYCLE START*/
...
#ifndef TESTING //for the moment this function is excluded
  ...
  if (sys.execute) { // Enter only if any bit flag is true
    ...
    if (rt_exec & (EXEC_ALARM | EXEC_CRIT_EVENT)) {      
      ...
      if (rt_exec & EXEC_CRIT_EVENT) {
        //TODO: report_alarm_message(ALARM_HARD_LIMIT); 
        //TODO: report_feedback_message(MESSAGE_CRITICAL_EVENT);
      ...
      // Standard alarm event. Only abort during motion qualifies.
        ...
        //TODO: report_alarm_message(ALARM_ABORT_CYCLE);
      }
